...
All of your documentation for this course should be done under your repository at [version.aalto.fi](https://version.aalto.fi/gitlab/)
...
## Testing the changes locally on your computer

{{<hint warning>}}
This will surely feel a little bit intimidating if you are not familiar working with git
{{</hint>}}
